...
interface InvoiceFormData {
  ...
  paidAmount: number;
  restAmountUSD?: number; // أصبح اختيارياً
  restAmountEGP?: number; // أصبح اختيارياً
  wayOfPayment: string;
  paymentDate: string;
...
export default function NewAccounting() {
  ...
  useEffect(() => {
    const subscription = watch((formValues, { name }) => {
      ...
      const entranceTicketsTotal = convertToEGP(
        formValues.entranceTickets?.total,
        formValues.entranceTickets?.currency,
        formValues.entranceTickets?.exchangeRate
      );
              ...
              <div className="space-y-4">
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      <TableCell>
                        <Input placeholder="site" className="w-fit" />
                      </TableCell>
                      ...
                      <TableCell>
                        <Input placeholder="No" className="w-full" />
                      </TableCell>
                      <TableCell>
                        <Input
                          type="number"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                  <div>
                    ...
                    <Input
                      type="number"
                      step="0.01"
                      {...register("entranceTickets.total")}
                      placeholder="0.00"
                    />
                  </div>
                  <div>
                    <Label>Currency</Label>
                    <RadioGroup
                      defaultValue={watch("entranceTickets.currency") || "EGP"}
                      className="flex items-center space-x-4 pt-2"
                      onValueChange={(value) =>
                        setValue(
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="EGP" id="tickets-egp" />
                        <Label htmlFor="tickets-egp">EGP</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="USD" id="tickets-usd" />
                        <Label htmlFor="tickets-usd">USD</Label>
                      </div>
                    </RadioGroup>
                  </div>
                  {watch("entranceTickets.currency") === "USD" && (
                    <div>
                      <Label>Exchange Rate ($ to E£)</Label>
                      <Input
                        type="number"
                        step="0.01"
                        {...register("entranceTickets.exchangeRate")}
                        placeholder="e.g., 47.50"
                      />
                    </div>
                  )}
                  ...
                  <div key={field.id} className="border rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                      <div>
                        ...
                        <Select
                          onValueChange={(value) =>
                            setValue(`transportation.${index}.city`, value)
                          }
                        >
                          <SelectTrigger>
                      ...
                      <div>
                        ...
                        <Input
                          {...register(`transportation.${index}.supplierName`)}
                      ...
                      <div>
                        ...
                        <Input
                          {...register(`transportation.${index}.siteCostNo`)}
                        ...
                        >
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem
                              ...
                              id={`trans-egp-${index}`}
                            />
                            <Label htmlFor={`trans-egp-${index}`}>EGP</Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem
                              value="USD"
                              id={`trans-usd-${index}`}
                            />
                            <Label htmlFor={`trans-usd-${index}`}>USD</Label>
                          </div>
                        </RadioGroup>
                      </div>
